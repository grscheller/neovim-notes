...
| Command                   | Description                              |
|:------------------------- |:---------------------------------------- |
| :set encoding             | list current encoding of buffer          |
| :set encoding=utf-8       | set current encoding of buffer           |
| :set fileencoding         | list encoding of to save to file         |
| :set encoding=latin1      | edit using LATIN-1 character encoding    |
| :set fileencodings=latin1 | save files with LATIN-1 encoding         |
| :set fileencodings        | list encodings to try when loading files |
...
| ASCII | Decimal    | Octal | Binary     | Symbol |
| -----:|:---------- |:-----:|:----------:|:------:|
| `107` | `64+32+11` | `153` | `01101011` | `k`    |
| `75`  | `64+11`    | `113` | `01001011` | `K`    |
| `11`  | `11`       | `013` | `00001011` | `VT`   |
| `100` | `64+32+4`  | `144` | `01100100` | `d`    |
| `68`  | `64+4`     | `104` | `01000100` | `D`    |
| `4`   | `4`        | `004` | `00000100` | `EOT`  |
| `123` | `64+32+27` | `173` | `01111011` | `{`    |
| `91`  | `64+27`    | `133` | `01011011` | `[`    |
| `27`  | `27`       | `033` | `00011011` | `ESC`  |

Pro-trick: `<C-[>jk` is the same as `<Esc>`
